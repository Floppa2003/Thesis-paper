...
int main()
{
    ...
    std::ofstream result_file("../data/random_sampling_continuous_mu.csv");
    ...
    result_file.close();
    std::cout << "Computation complete! Results saved to random_sampling_continuous_mu.csv" << std::endl;
