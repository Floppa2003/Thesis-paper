...
int main()
{
    ...
    std::ofstream result_file("../data/random_sampling_stratified_continuous.csv");
    ...
    result_file.close();
    std::cout << "Computation complete! Results saved to random_sampling_stratified_continuous.csv" << std::endl;
